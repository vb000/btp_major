...
class performanceparams_gui():
   def __init__(self,parent):
       self.gui=lineparams_gui(parent)
       ...
       self.corona_button=Button(self.gui.output_frame,text="Corona performance"\
                                                   ,command=self.display_cig)
   ...
   def compute_vg(self):
       ...
       if self.gui.groundconductors_no.get() != 0:
           ...
           self.gui.obj.phase_svg_mat  = phase_svg_mat
           self.gui.obj.ground_svg_mat = ground_svg_mat
       else:
   ...
   def display_vg(self):
       ...
       if self.gui.groundconductors_no.get() != 0:
           ...
           phase_svg="surface voltage gradient of phase conductors =\n" \
                      + str(self.gui.obj.phase_svg_mat) + "kv/cm\n"
           ground_svg="surface voltage gradient of ground conductors =\n" \
                      + str(self.gui.obj.ground_svg_mat) + "kv/cm\n"
